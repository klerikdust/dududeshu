...
public static class Localization
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Strings = new()
    {
        ["en"] = new()
        {
            ...
            ["enable.romaji"]             = "Show romaji in parentheses",
            ["enable.pinyin"]             = "Show pinyin in parentheses",
        ...
        ["id"] = new()
        {
            ...
            ["enable.romaji"]             = "Tampilkan romaji dalam tanda kurung",
            ["enable.pinyin"]             = "Tampilkan pinyin dalam tanda kurung",
        ...
        ["zh-TW"] = new()
        {
            ...
            ["enable.romaji"]             = "在括號中顯示羅馬字",
            ["enable.pinyin"]             = "在括號中顯示拼音",
